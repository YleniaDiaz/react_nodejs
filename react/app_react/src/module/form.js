 ...
 render(){
      ...
      <div>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control"  placeholder="Phone"  value={this.state.campPhone} onChange={(value)=> this.setState({campPhone:value.target.value})}/>
          </div>
        </div>
  ...
  sendSave(){
    ...
    if (this.state.selectRole==0) {
      ...
      //URL BACKEND
      const baseUrl = "http://192.168.1.45:3000/employee/create"
